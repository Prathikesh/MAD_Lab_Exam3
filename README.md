...
- **Kotlin**: Entirely developed in Kotlin, leveraging its modern features for efficient Android app development.
- **Shared Preferences**: Data storage using shared preferences, offering lightweight and persistent data handling without external databases.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Prathikesh/MAD_Lab_Exam3.git
